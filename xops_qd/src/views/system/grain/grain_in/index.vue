...
<div class="app-container">
    ...
    <el-table v-loading="loading" stripe="true" :data="data" size="small" show-summary border style="width: 100%">
        <el-table-column label="详情" min-width="50px">
            ...
            <el-table-column prop="customer_name" label="客户名" min-width="100px" />
            <el-table-column prop="mobile" label="手机" min-width="105px" />
            <el-table-column prop="gross_weight" label="毛重(千克)" min-width="64px" />
            <el-table-column prop="vehicle_weight" label="皮重(千克)" min-width="64px" />
            <el-table-column prop="sub_weight" label="扣量(千克)" min-width="64px" />
            <el-table-column prop="net_weight" label="净重(斤)" min-width="64px" />
            <el-table-column prop="unit_price" label="单价" min-width="50px" />
            <el-table-column prop="amount_pay" label="应付款" min-width="85px" />
            <el-table-column prop="pay_name" label="款项" min-width="50px" />
            <el-table-column prop="actual_pay" label="已付款" min-width="85px" />
            <el-table-column prop="naure_name" label="性质" min-width="46px" />
            <el-table-column prop="invoice_date" label="创建时间" min-width="145px" />
            <el-table-column prop="update_time" label="更新时间" min-width="145px" />
        </el-table-column>
        <el-table-column label="操作" min-width="205px" align="center">
            <template slot-scope="scope">
                <edit v-if="checkPermission(['admin','user_all','user_edit'])" :data="scope.row" :sup_this="sup_this" min-width="66" />
                ...
                <el-popover v-if="checkPermission(['admin','user_all','user_delete'])" :ref="scope.row.voucher_number" placement="top" min-width="180">
                    ...
                    <el-button slot="reference" type="danger" size="mini" min-width="6">删除</el-button>
                </el-popover>
            </template>
        </el-table-column>
    </el-table>
