...
class WarehousEntry(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=5, decimal_places=2, verbose_name='收购单价')
    amount_pay = models.DecimalField(max_digits=16, decimal_places=2, verbose_name='应付金额', null=True, blank=True)
    actual_pay = models.DecimalField(max_digits=16, decimal_places=2, verbose_name='实付金额' , default=0)
...
class OutStock(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=5, decimal_places=2, verbose_name='出库单价')
    amount_pay = models.DecimalField(max_digits=16, decimal_places=2, verbose_name='应付金额', default=0)
    pay_choices = ((1,'付款'), (0, '欠账'))
    pay = models.SmallIntegerField(choices=pay_choices, verbose_name='款项', default=0)
